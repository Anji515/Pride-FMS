...
export default function Contact() {
  ...
  return (
    <section id="contact" ref={containerRef} className="py-20 bg-white dark:bg-gray-950">
      <motion.div style={{ y }} className="container mx-auto px-4" ref={ref}>
        ...
        >
          ...
          <p className="max-w-2xl mx-auto text-gray-600 dark:text-gray-300 text-lg">
            Have questions or ready to get started? Reach out to us today and our team will get back to you promptly.
          </p>
        </motion.div>
          ...
          >
            <Card className="border-0 shadow-none bg-transparent">
              <CardHeader className="px-0">
                <CardTitle className="text-2xl font-bold text-gray-800 dark:text-white">Get In Touch</CardTitle>
              </CardHeader>
