      ...
      <div className="container mx-auto px-4 pt-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          <div className="lg:col-span-2">
            <Link href="/" className="inline-block mb-6">
              ...
              >
                <Image src="/logo-dark.png" alt="Pride Facility Logo" fill className="object-contain" />
              </motion.div>
            </Link>
            <p className="text-gray-400 mb-6 max-w-md">
              Pride Facility provides comprehensive facility management solutions tailored to meet your specific needs.
              With over 25 years of experience, we are committed to excellence in every service we provide.
            </p>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} Pride Facility. All rights reserved.
          </p>
